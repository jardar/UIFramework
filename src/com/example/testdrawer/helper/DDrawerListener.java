package com.example.testdrawer.helper;
...
import com.example.testdrawer.helper.DActionBarDrawerToggleHoneycomb;
...
public class DDrawerListener implements DrawerLayout.DrawerListener {
	...
	private static class ActionBarDrawerToggleImplHC implements
		...
		@Override
		public Drawable getThemeUpIndicator(Activity activity) {
			return DActionBarDrawerToggleHoneycomb
		...
		public Object setActionBarUpIndicator(Object info, Activity activity,
				Drawable themeImage, int contentDescRes) {
			return DActionBarDrawerToggleHoneycomb.setActionBarUpIndicator(
		...
		public Object setActionBarDescription(Object info, Activity activity,
				int contentDescRes) {
			return DActionBarDrawerToggleHoneycomb.setActionBarDescription(
	 ...
	 *            accessibility
	 */
	public DDrawerListener(Activity activity, DrawerLayout drawerLayout,
	...
	private class SlideDrawable extends InsetDrawable implements
			Drawable.Callback {
		...
		public void draw(Canvas canvas) {
			...
			final boolean isLayoutRTL = ViewCompat.getLayoutDirection(mActivity
					.getWindow().getDecorView()) == ViewCompat.LAYOUT_DIRECTION_RTL;

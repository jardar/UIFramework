...
public class DFragment extends Fragment implements DIFragment,
	 ...
	 */
	public static DFragment newInstance(int sectionNumber) {
	...
	public boolean setupActionBar(Menu menu) {
		...
		actionBar.setTitle("Section " + textView.getText().toString());
		return true;
	}

	@Override
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		Log.i(TAG, "***999.onCreateOptionsMenu(DFragment)");
